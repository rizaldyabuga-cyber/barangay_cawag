...
<div class="container">
    ...
    <div class="profile-section">
        <?php
$photo = !empty($row['photo']) ? "uploads/" . htmlspecialchars($row['photo']) : "default.png";
?>
...
<img src="<?= $photo ?>" class="photo">
    ...
    <div class="info-grid">
        ...
        <div class="info-box">
            ...
            <span><?= date("F d, Y", strtotime($row['birth_date'])); ?></span>
        </div>
    ...
    <a href="residents.php" class="btn-back">Back to List</a>
